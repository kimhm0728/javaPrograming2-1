...
class Car {
	...
	public String getPrice() {
		return "당신이 요청한 "+e.capacity+"의 "+e.fuel+"차랑(컬러:"+color+")의 가격은 "+e.getPrice();
	}
}*/
class Car extends Engine {
	...
	public String getPrice2() {
		return "당신이 요청한 "+capacity+"의 "+fuel+"차랑(컬러:"+color+")의 가격은 "+getPrice();
	}
}
public class CarTest {
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("차량의 가격은 : "+c.getPrice());
		stdin.close();
	}
}